...
export default function page() {
  return (
    <div className="min-h-screen">
      ...
      <div className="m-auto md:py-10 lg:py-10 max-w-6xl px-4 sm:px-6 md:px-8 animate__animated animate__fadeInDown text-stone-800 dark:text-stone-200 overflow-hidden">
