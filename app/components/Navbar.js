      ...
      <nav className="navbar">
        ...
        <div className={`md:hidden ${isOpen ? "block" : "hidden"}`}>
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 dark:text-white">
            <Link href="/">
              <p className="hover:text-slate-200 hover:bg-stone-800 dark:hover:text-slate-700 dark:hover:bg-stone-300 transition ease-in block px-3 py-2 rounded-md text-base font-medium">
                Home
              </p>
            </Link>
            <Link href="/about">
