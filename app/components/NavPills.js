...
const NavPills = ({ tabs }) => {
  ...
  return (
    <div className="flex justify-center md:py-5 lg:py-5 font-sans">
      <div className="w-95 md:w-98 lg:w-100">
        <div className="py-10">
          <h1 className="font-bold border-l-4 border-blue-500 text-3xl sm:text-4xl md:text-3xl">
            SKILLS
          </h1>
        </div>
        <ul className="flex">
            ...
            <li key={tab.id} className="-mb-px mr-1">
              <a
                ...
                className={`py-2 px-4 transition-all ease-in font-bold ${
                  activeTab === tab.id
                    ? "text-white bg-slate-700 dark:bg-slate-200 dark:text-slate-800 rounded-3xl font-semibold"
